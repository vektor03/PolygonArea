...
namespace Polygon
{
    ...
    class PolygonArea
    {
        ...
        public PolygonArea(PointF[] dots)
        {
            ...
            //Рассчитав векторное произведение мы получаем площадь и ориентацию. Назовем скалярное значение этого вектора площадью*.
            //Вся идея алгортма в том что если многоугольник не имеет пересечений, то сложив по очереди площади* всех треугольников  
            //образованных каждой стороной многоугольника и произвольной точкой (допустим 0,0), мы получим площадь многоугольника.
